    ...
    <div class="container-fluid mb-4">
        <form id="product-form" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-12" style="{{ Auth::user()->email == 'mark@theliquorhq.com' ? 'display:none;' : '' }}">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-md-7">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="wholesale_price" type="text" class="form-control"
                                                name="wholesale_price" required value="{{ $product->wholesale_price }}">
                                        </div>
                                    </div>
                                @endif
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="supplier_id" id="supplier_id">
                                            ...
                                            @foreach (\Modules\People\Entities\Supplier::all() as $supplier)
                                                <option {{ $supplier->id == $product->supplier->id ? 'selected' : '' }} value="{{ $supplier->id }}">{{ $supplier->supplier_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
