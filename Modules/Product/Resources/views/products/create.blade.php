                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                @if (env('WHOLESALE_RETAIL'))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wholesale_price">Wholesale Price <span
                                                    class="text-danger">*</span></label>
                                            <input id="wholesale_price" type="text" class="form-control"
                                                name="wholesale_price" required value="{{ old('wholesale_price') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="factor">Factor <span
                                                    class="text-danger">*</span></label>
                                            <input id="factor" type="numeric" class="form-control"
                                                name="factor" required value="{{ old('factor') }}">
                                        </div>
                                    </div>
                                @endif
                            </div>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_quantity"
                                            value="{{ old('product_quantity') }}" min="0.01">
                                    </div>
                                </div> --}}
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_stock_alert" required
                                            value="{{ old('product_stock_alert') }}" min="0">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_order_tax"
                                            value="{{ old('product_order_tax') }}" min="0.01">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            {{-- <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="category_id">Location <span class="text-danger">*</span></label>
                                        <select class="form-control" name="category_id" id="category_id" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_order_tax">Quantity</label>
                                        <input type="number" class="form-control" name="product_order_tax" value="{{ old('product_order_tax') }}" min="0.01">
                                    </div>
                                </div>
                            </div> --}}
