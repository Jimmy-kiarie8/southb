...
use Modules\GoodIssue\DataTables\GoodIssueDataTable;
use Modules\GoodIssue\Entities\GoodIssue;
use Modules\GoodIssue\Entities\GoodIssueDetail;
...
class GoodIssueController extends Controller
{
    ...
    public function index(GoodIssueDataTable $dataTable)
    {
        abort_if(Gate::denies('access_sales'), 403);
        // return request('payment_status');
        return $dataTable->render('goodissue::index');
    }
