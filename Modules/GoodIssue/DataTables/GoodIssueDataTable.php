...
namespace Modules\GoodIssue\DataTables;
...
class GoodIssueDataTable extends DataTable
{
    ...
    public function dataTable($query) {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                return view('goodissue::partials.actions', compact('data'));
            });
    }

    public function query(GoodIssue $model) {
