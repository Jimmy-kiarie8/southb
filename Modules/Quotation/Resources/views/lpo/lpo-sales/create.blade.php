                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="sale-form" action="{{ route('purchases.store') }}" method="POST">
                            ...
                            <input type="hidden" name="lpo_id" value="{{ $lpo_id }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('checkout-form').addEventListener('submit', function(e) {
                ...
                if (submitButton.disabled) {
                    e.preventDefault(); // Prevent submitting if already disabled
                } else {
                    submitButton.disabled = true;
                    submitButton.innerHTML = 'Processing...'; // Optional: Change button text
                }
            });
        });
    </script>
