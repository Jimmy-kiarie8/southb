<div class="btn-group dropleft">
    ...
    <div class="dropdown-menu">
        ...
        <a href="{{ route('purchase-payments.bulkShow', $data->id) }}" class="dropdown-item">
            ...
            <button id="delete" class="dropdown-item" onclick="
                ...
                <form id="destroy{{ $data->id }}" class="d-none" action="{{ route('purchase-payments.reversePayment', $data->id) }}" method="POST">
                    @csrf
                    @method('delete')
                </form>
            </button>
