...
class HomeController extends Controller
{
    ...
    public function index() {
        ...
        foreach (Sale::completed()->with(['saleDetails' => function($q) {
            $q->with(['product']);
        }])->get() as $sale) {
            foreach ($sale->saleDetails as $saleDetail) {
                // dd($saleDetail->product);
    ...
    public function mobile() {
        ...
        return response()->json([
            ...
            'sale_returns'     => format_currency($sale_returns),
            'purchase_returns' => format_currency($purchase_returns),
    ...
    public function stk_response(Request $request, $id) {
        ...
        $payment->stk_response($request, $id);
    }
}
