...
class ProductTransfer extends Component
{
    ...
    public $listeners = ['productSelected', 'discountModalRefresh', 'locationChange'];
    ...
    public function productSelected($product) {
        $location =  ProductBranch::where('product_id', $product['id'])->where('branch_id', $this->location_from)->first('quantity');

        if (!$location) {
            session()->flash('message', 'Product does not existsin this location!');
            return;
        }
