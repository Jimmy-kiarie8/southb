                ...
                <div class="card-body">
                    <form wire:submit.prevent="generateReport">
                                ...
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="customer_id" class="form-control" name="customer_id">
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->code }}">{{ $customer->customer_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model.defer="payment_status" class="form-control"
                                        name="payment_status">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <button class="btn btn-primary" wire:click="pdf2">
                                <span wire:target="export" wire:loading class="spinner-border spinner-border-sm"
                                    role="status" aria-hidden="true"></span>
                                <i wire:target="export" wire:loading.remove class="bi bi-file-pdf"></i>
                                Profit Report
                            ...
                            <button class="btn btn-primary" wire:click="pdf3">
                                <span wire:target="export" wire:loading class="spinner-border spinner-border-sm"
                                    role="status" aria-hidden="true"></span>
                                <i wire:target="export" wire:loading.remove class="bi bi-file-pdf"></i>
                                Payment Summary
